...
% Content Image
content = read_and_process('fox.jpg');
figure;
image(content);
...
des_res = run_net_full(content, in_net);
...
for i = 1:num_iterations
    ...
    act_res = run_net_full(white_noise, in_net);
    ...
    back_res = run_net_full(white_noise, in_net, act_res, gradient);
